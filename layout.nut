...
class UserConfig {
   ...
   </ label="Enble background Scanline", help="Show scanline effect", options="none,light,medium,dark", order=4 /> enable_scanline="none";
   </ label="Select wheel layout", help="Select wheel type or listbox", options="listbox, wheel_right, wheel_left, vert_wheel_right, vert_wheel_left", order=5 /> enable_list_type="wheel_left";
   </ label="Select spinwheel art", help="The artwork to spin", options="marquee, wheel", order=6 /> orbit_art="wheel";
   </ label="Wheel transition time", help="Time in milliseconds for wheel spin.", order=7 /> transition_ms="35";  
   </ label="Wheel fade time", help="Time in milliseconds to fade the wheel.", options="Off,2500,5000,7500,10000,12500,15000,17500,20000,22500,25000,27500,30000", order=8 /> wheel_fade_ms="5000";
   ...
   </ label="Enable system logos", help="Select system logos", options="Yes,No", order=13 /> enable_slogos="Yes"; 
</ label="-------- Logo/Marquee images --------", help="Show or hide logo/marquee images", order=14 /> uct3="select below";
   </ label="Enable logos/marquees", help="Show logo or marquees", options="Yes,No", order=15 /> enable_logomarquee="Yes";
   </ label="Select logo or marquee", help="Select logo or marquees", options="logo, emulator, marquee", order=16 /> enable_marquee="logo";
</ label="--------   Pointer images    --------", help="Change pointer image", order=17 /> uct4="select below";
   </ label="Select pointer", help="Select animated pointer", options="default,emulator,rocket,hand,none", order=18 /> enable_pointer="none"; 
</ label="--------    Game info box    --------", help="Show or hide game info box", order=19 /> uct5="select below";
   </ label="Enable game information", help="Show game information", options="Style1,Style2,No", order=20 /> enable_ginfo="Style1";
   ...
   </ label="Enable monitor static effect", help="Show static effect when snap is null", options="Yes,No", order=23 /> enable_static="No";    
}  
